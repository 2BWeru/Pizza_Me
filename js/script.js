...
//toppings
const pizzaToppings = ["Mushrooms", "Pineapple", "Bacon","sausage","chicken","Extra Cheese","peppers"];
        ...
        if (selectd.val() == undefined) {
            ...
            if (selectd.val() == "delivery") {
                ...
                function calculateGrandTotal() {
                    ...
                    <div class="alert alert-success" role="alert">Hello ${customerName}.Your Order has been processed successfully. It will be delivered to your location(${customerLocation})</div><br><p>Do contact us at :0756091233 for further assistance</p>
                    <br>
                    <br>   
